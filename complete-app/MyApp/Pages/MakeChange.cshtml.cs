...
namespace MyApp.Pages
{
    ...
    public class MakeChangeModel : PageModel
    {
        ...
        [BindProperty] public double Amount { get; set; } = 0.0d;
        ...
        public void OnPost()
        {
            ...
            else
            {
                ...
                ChangeBreakdown = String.Format("We can make change for ${0:0.00} with {1} nickels and {2} pennies!",
                    Amount, Nickels, Pennies);
            }
        }
    }
}